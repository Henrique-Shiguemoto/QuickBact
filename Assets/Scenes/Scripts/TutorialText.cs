...
public class TutorialText : MonoBehaviour
{
    ...
    private string[] tutorialTexts = {"You need to collect all the <color=#de2626>strawberrys</color> on the map before your time runs out!",
                                      "There are also <color=#d1931f>oranges</color> to increase you speed!",
                                      "But be careful! There are enemies that will come after you! Don't let touch you!",
